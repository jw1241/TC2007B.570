...
import {
  transition
} from "./chunk-UMQLI4CX.js";
import {
  getIonMode,
  isPlatform
} from "./chunk-4ALN6BNB.js";
import {
  clamp,
  componentOnReady,
  hasLazyBuild,
...
} from "./chunk-V43BTFNX.js";
import {
  shouldUseCloseWatcher
} from "./chunk-6YDUM6KQ.js";
  ...
  componentDidLoad() {
    {
      this.rIC(() => __async(this, null, function* () {
        ...
        if (!config.getBoolean("_testing")) {
          import("./index-BtUdxPjv-JCGLOBMK.js").then((module) => module.startTapClick(config));
        }
        if (config.getBoolean("statusTap", isHybrid)) {
          import("./status-tap-BfJqFSLF-DHNIDYJM.js").then((module) => module.startStatusTap());
        }
        if (config.getBoolean("inputShims", needInputShims())) {
          const platform = isPlatform(window, "ios") ? "ios" : "android";
          import("./input-shims-DbrgeeNb-34RQQHQT.js").then((module) => module.startInputShims(config, platform));
        }
        const hardwareBackButtonModule = yield import("./hardware-back-button-CTe4XmL7-ONHFDFNV.js");
...
var RouterOutlet = class {
  ...
  connectedCallback() {
    return __async(this, null, function* () {
      ...
      this.gesture = (yield import("./swipe-back-BZBFwTQV-IU23X7H2.js")).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => {
        var _a;
...
//# sourceMappingURL=ion-app_8.entry-53FCSNHE.js.map
